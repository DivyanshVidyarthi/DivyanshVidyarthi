...
2. C/C++ and Rust (for working with core Linux)
3. Pentesting Tools (Metasploit, Nmap, BurpSuite, Splunk, Wireshark, etc.) 
4. Bash (Scripting in Linux)

Solving CTF's on [![HackTheBox](https://img.shields.io/badge/HackTheBox-Profile-green?logo=hackthebox&logoColor=black)](https://profile.hackthebox.com/profile/019fe2d3-794b-71cb-a247-972cd44ad037) and [![TryHackMe](https://img.shields.io/badge/TryHackMe-Profile-red?logo=tryhackme&logoColor=white)](https://tryhackme.com/p/Ca5uaL) for getting Real world application about pentesting and how we can secure out systems...
